...
var Types = {
    ...
    /**
     * Asserts that value is of type for a given type. The type can either be
     * a wolperting Type or one of the javascript primitives:
     * Number, Object, String, Function, Boolean, and additionally Date
     *
     * Examples:
     *
    ...
    assert: function(value, type, name) {
        ...
        return Types.isa(value, type, name);
    },
     ...
     * Type Tuple
     *
     * A tuple is an array of set length, of said type annotations.
     * example:
     *
     *  Types.Tuple( Number, Number
     */
    Tuple: function() {
